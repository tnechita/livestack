...
const CUSTOMER_STORAGE_KEY = 'LifesciencesLivestack.customerName';
const CUSTOMER_ALIASES = [
  'Seer Lifesciences',
  'Seer Life Sciences',
  'Life Sciences LiveStack',
  'Life Sciences',
  'Seer Equity Bank',
  'Seer Equity',
  'Seer Bank',
...
const NAV_ITEMS = [
  ...
  { id: 'dashboard', label: 'Quality & Supply Operations Dashboard', iconClass: 'oj-fwk-icon oj-fwk-icon-grid', featureTags: ['In-Memory', 'Native JSON'] },
  { id: 'social', label: 'Regulatory & Quality Signals', iconClass: 'oj-fwk-icon oj-fwk-icon-sortrelevancehigh', featureTags: ['Vector Search', 'VPD'] },
  { id: 'graph', label: 'Signal Propagation Network', iconClass: 'oj-fwk-icon oj-fwk-icon-node-expand', featureTags: ['Property Graph', 'SQL/PGQ'] },
  { id: 'fulfillment', label: 'Cold-Chain Service Coverage', iconClass: 'oj-fwk-icon oj-fwk-icon-calendar-clock', featureTags: ['Oracle Spatial', 'VPD'] },
  { id: 'orders', label: 'Clinical Supply Orders & Deviations', iconClass: 'oj-fwk-icon oj-fwk-icon-tree-document', featureTags: ['JSON Duality', 'VPD'] },
  { id: 'oml', label: 'Predictive Quality & Supply Analytics', iconClass: 'oj-fwk-icon oj-fwk-icon-view', featureTags: ['OML', 'Vector K-Means'] },
  { id: 'askdata', label: 'Ask Seer Regulated Supply Data', iconClass: 'oj-fwk-icon oj-fwk-icon-magnifier', featureTags: ['Natural Language SQL', 'Live Schema'] },
  { id: 'agents', label: 'Governed Agent Console', iconClass: 'oj-fwk-icon oj-fwk-icon-users', featureTags: ['PL/SQL Tools', 'JSON Audit'] },
];
...
function replaceCustomerTerms(value, profile) {
  ...
  let next = value.replace(/\bseer-Lifesciences\.example\b/gi, profile.customerDomain);
  next = next.replace(/\bLife sciences supply intelligence\b/g, `${profile.customerName} supply intelligence`);
  next = next.replace(/\blife sciences supply platform\b/gi, `${profile.customerName} regulated supply platform`);
...
function hasReplaceableCustomerTerms(value) {
  return typeof value === 'string' && (
    /\bseer-Lifesciences\.example\b/i.test(value) ||
    /\bLife sciences supply intelligence\b/.test(value) ||
    /\blife sciences supply platform\b/i.test(value) ||
    /\b(?:Seer Lifesciences|Seer Life Sciences|Life Sciences LiveStack|Life Sciences|Seer Equity Bank|Seer Equity|Seer Bank|Seer)\b/.test(value)
  );
}
    ...
    <div className="customer-name-tool">
      ...
      {isOpen && (
        <form className="customer-name-tool__panel" onSubmit={submit}>
          ...
          <p className="customer-name-tool__hint">Replaces Seer Lifesciences and Life Sciences labels on visible screens.</p>
        </form>
      )}
    </div>
  );
