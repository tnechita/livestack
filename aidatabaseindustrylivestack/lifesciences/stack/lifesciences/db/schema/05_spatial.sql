...
-- Buyer LOCATION column is defined on the customers table in 01_tables.sql
...
CREATE TABLE demand_regions (
    ...
    social_density    NUMBER(8,2),      -- regulatory/supply signals per 1000 population
...
-- Find the N nearest fulfillment centers to a buyer
