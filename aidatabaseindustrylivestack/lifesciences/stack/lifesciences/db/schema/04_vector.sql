...
--   GRANT EXECUTE ON DBMS_VECTOR             TO Lifesciences;
--   GRANT READ, WRITE ON DIRECTORY data_pump_dir TO Lifesciences;
-- ============================================================
...
-- ============================================================
-- PRODUCT EMBEDDINGS
-- Pre-computed vector embeddings for life sciences product descriptions
...
CREATE TABLE product_embeddings (
    ...
    embedding         VECTOR(384,FLOAT32,DENSE), -- fixed MiniLM contract
...
CREATE TABLE post_embeddings (
    ...
    embedding_model   VARCHAR2(100) DEFAULT 'all_MiniLM_L12_v2',
    embedding_text    CLOB,
    embedding         VECTOR(384,FLOAT32,DENSE),
    created_at        TIMESTAMP DEFAULT SYSTIMESTAMP,
...
AS
    v_post_vector VECTOR(384,FLOAT32,DENSE);
BEGIN
...
AS
    v_query_vec VECTOR(384,FLOAT32,DENSE);
BEGIN
