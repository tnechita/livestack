/*
 * load_customers.sql
 * 2000 trial sites across US metro areas
 */

SET SERVEROUTPUT ON
PROMPT Loading trial sites...
...
BEGIN
    ...
    FOR i IN 1..2000 LOOP
        ...
        v_email := 'site-' || LPAD(i, 4, '0') || '@seer-clinical.example';
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Trial sites loaded: ' || v_count);
END;
/
