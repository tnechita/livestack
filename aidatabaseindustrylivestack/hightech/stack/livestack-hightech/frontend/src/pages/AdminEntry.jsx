...
export default function AdminEntry({
  ...
  const headerContent = isOverlay ? 'Use Your Own Product Data' : 'Dataset Control';
  const headerDescription = isOverlay
    ? 'The high-tech demo dataset stays active by default. Upload your own v1 ZIP, validate it, or preview a restore before executing any replacement.'
    : 'Start on the seeded high-tech demo dataset, or load your own v1 ZIP before entering the experience.';
      ...
      >
        ...
        <div className="mt-6 glass-card p-5 space-y-4">
          ...
          <p className="text-xs text-[var(--color-text-dim)]">
            Preview the high-tech demo dataset import to see row counts and warnings, then execute the restore to overwrite the current data.
          </p>
          <div className="flex flex-wrap gap-3">
            <button
              className="btn-ghost inline-flex items-center gap-2"
