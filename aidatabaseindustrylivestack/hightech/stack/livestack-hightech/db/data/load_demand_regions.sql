 ...
 * Seed data for product demand regions
 *
 * WHY THIS WAS EMPTY:
 ...
 *
 * demand_regions captures geographic product availability segments with:
 *   - SDO_GEOMETRY boundary polygon (WGS84 / SRID 4326)
 *   - population, avg_income, community signal density
 *   - product demand index (0-100, Oracle AI-scored)
 *
 * Used by: OML Analytics and Product Availability Map heat overlays
 *
...
PROMPT Loading product demand regions...
