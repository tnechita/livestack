/*
 * load_graph_data.sql
 * developer advocate connections (3000+ edges) and technology portfolio advocate links
 */

SET SERVEROUTPUT ON
PROMPT Loading developer advocate graph edges...
...
BEGIN
    ...
    -- Generate ~3000 developer advocate connections
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('developer advocate connections loaded: ' || v_count);

    -- Generate technology portfolio advocate links (~1500)
    v_count := 0;
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Technology portfolio advocate links loaded: ' || v_count);
END;
/
