/*
 * load_customers.sql
 * 2000 synthetic enterprise buyers across US metro areas
 */

SET SERVEROUTPUT ON
PROMPT Loading synthetic enterprise buyers...
...
BEGIN
    ...
    FOR i IN 1..2000 LOOP
        ...
        v_email := LOWER(v_fnames(MOD(i, v_fnames.COUNT) + 1)) || '.' ||
                   ...
                   i || '@synthetic-enterprise-buyer.example';
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Synthetic enterprise buyers loaded: ' || v_count);
END;
/
