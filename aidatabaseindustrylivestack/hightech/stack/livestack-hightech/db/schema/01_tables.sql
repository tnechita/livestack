...
-- ============================================================
-- FULFILLMENT CENTERS (product availability centers / service hubs kept on baseline table name)
-- ============================================================
...
-- ============================================================
-- INVENTORY (high-tech product capacity / hardware supply units at each access center)
-- ============================================================
...
CREATE TABLE orders (
    ...
    social_source_id   NUMBER,         -- FK to social_posts if solution order was influenced by a customer and developer signal
