...
const TEMPLATE_NOTES = [
  ...
  'Derived columns such as customers.location, fulfillment_centers.location, order_items.line_total, fulfillment_zones, product_embeddings, presenter-facing signal embeddings, and semantic_matches are regenerated by the importer.',
  'inventory.csv is required. shipments.csv is optional and can be omitted when allocation routes should be regenerated.',
  'When optional developer ecosystem graph, allocation route, or demand files are omitted, the importer regenerates fallback data.',
...
function buildManifest() {
  return {
    ...
    format: 'high-tech-product-intelligence-import',
