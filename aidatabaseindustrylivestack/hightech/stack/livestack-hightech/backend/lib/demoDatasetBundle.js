...
function buildReadme() {
  return [
    '# Bundled Seer Tech Product Intelligence Demo Dataset',
    '',
    'This archive restores the canonical seeded high-tech demo dataset for the application.',
...
function createArchive() {
  ...
  return {
    ...
    fileName: `high-tech-product-intelligence-demo-dataset-${IMPORT_VERSION}.zip`,
    buffer: zip.toBuffer(),
  };
}
