...
function buildReadme() {
  return [
    '# Bundled Transportation Fleet Logistics Demo Dataset',
    '',
    'This archive restores the canonical seeded transportation demo dataset for the application.',
...
function createArchive() {
  ...
  return {
    ...
    fileName: `transportation-fleet-logistics-demo-dataset-${IMPORT_VERSION}.zip`,
    buffer: zip.toBuffer(),
  };
}
