/*
 * 03_graph.sql
 * Property Graph for partner networks and brand propagation
...
/*
-- Find influencers within 2 hops of an urgent signal post author
...
FROM GRAPH_TABLE ( influencer_network
    ...
    WHERE a.handle = '@teletransport_mark'
...
-- Service line propagation: which influencers propagate a service line through the network
...
FROM GRAPH_TABLE ( influencer_network
    ...
    WHERE b.brand_name = 'MetroLine Freight'
    COLUMNS (
        v1.handle, v2.handle,
        e1.relationship_type,
        e2.connection_type,
