 ...
 * 500 transportation operations voices across social and partner channels
 */

SET SERVEROUTPUT ON
PROMPT Loading transportation signal voices...
...
BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Transportation signal voices loaded: ' || v_count);
END;
/
