...
PROMPT =====================================================
PROMPT  Resetting Transportation Fleet Logistics Demo Data
PROMPT =====================================================
...
TRUNCATE TABLE transport_case_entities;
TRUNCATE TABLE transport_relationships;
TRUNCATE TABLE transport_exception_cases;
TRUNCATE TABLE transport_entities;
TRUNCATE TABLE agent_actions;
TRUNCATE TABLE shipments;
TRUNCATE TABLE order_items;
TRUNCATE TABLE orders;
TRUNCATE TABLE post_embeddings; -- exposed to presenters through signal_embeddings view
