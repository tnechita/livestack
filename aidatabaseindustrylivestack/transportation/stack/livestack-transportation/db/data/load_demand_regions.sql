 ...
 * Seed data for transport demand regions
 *
 * WHY THIS WAS EMPTY:
 ...
 *
 * demand_regions captures geographic terminal access segments with:
 *   - SDO_GEOMETRY boundary polygon (WGS84 / SRID 4326)
 *   - population, avg_income, community signal density
 *   - transport demand index (0-100, Oracle AI-scored)
 *
 * Used by: OML Analytics and Terminal Access Map heat overlays
 *
...
PROMPT Loading transport demand regions...
