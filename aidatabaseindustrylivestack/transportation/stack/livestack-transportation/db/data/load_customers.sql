/*
 * load_customers.sql
 * 2000 synthetic shippers across US metro areas
 */

SET SERVEROUTPUT ON
PROMPT Loading synthetic shippers...
...
BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Synthetic shippers loaded: ' || v_count);
END;
/
