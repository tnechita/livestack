...
export default function AdminEntry({
  ...
  const headerContent = isOverlay ? 'Upload Fleet Data' : 'Dataset Control';
  const headerDescription = isOverlay
    ? 'The transportation demo dataset stays active by default. Upload your own v1 ZIP, validate it, or preview a restore before executing any replacement.'
    : 'Start on the seeded transportation demo dataset, or load your own v1 ZIP before entering the experience.';
      ...
      >
        ...
        <div className="mt-6 glass-card p-5">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              ...
              {uploadConfirmed ? 'Confirm Replace Active Dataset' : 'Upload Data'}
            </button>
          </div>
          {uploadConfirmed && (
            <p className="mt-3 text-xs tone-sienna" role="status">
              Confirm replacement to overwrite the active dataset with the validated ZIP.
            </p>
          )}
        </div>
        ...
        <div className="mt-6 glass-card p-5 space-y-4">
          ...
          <p className="text-xs text-[var(--color-text-dim)]">
            Preview the transportation demo dataset import to see row counts and warnings, then execute the restore to overwrite the current data.
          </p>
          <div className="flex flex-wrap gap-3">
            <button
              className="btn-ghost inline-flex items-center gap-2"
